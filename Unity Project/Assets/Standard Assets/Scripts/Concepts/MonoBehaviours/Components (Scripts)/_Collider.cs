...
namespace EternityEngine
{
	public class _Collider : _Component
	{
		...
		public IntValue bouncinessCombineRule;
		...
		public FloatValue borderRadius;
		...
		public class Data : _Component.Data
		{
			...
			public int bouncinessCombineRule;
			public float radius;
			...
			public override void Set (_Component component)
			{
				...
				capsuleHeight = collider.capsuleHeight.val;
				capsuleRadius = collider.capsuleRadius.val;
				isVertical = collider.isVertical.val;
				segmentPnt0 = _Vector2.FromVec2(collider.segmentPnt0.val);
				segmentPnt1 = _Vector2.FromVec2(collider.segmentPnt1.val);
				trianglePnt0 = _Vector2.FromVec2(collider.trianglePnt0.val);
				trianglePnt1 = _Vector2.FromVec2(collider.trianglePnt1.val);
				trianglePnt2 = _Vector2.FromVec2(collider.trianglePnt2.val);
				polylinePnts = collider.polylinePnts.val.FromVec2s();
				polylineIdxs = collider.polylineIdxs.val;
				trimeshPnts = collider.trimeshPnts.val.FromVec2s();
				trimeshIdxs = collider.trimeshIdxs.val;
				convexHullPnts = collider.convexHullPnts.val.FromVec2s();
				borderRadius = collider.borderRadius.val;
			...
			public override void Apply (_Component component)
			{
				...
				collider.density.Set (density);
				collider.bounciness.Set (bounciness);
				collider.bouncinessCombineRule.Set (bouncinessCombineRule);
				...
				collider.borderRadius.Set (borderRadius);
